...
style.font = function(id, name, text, callback) {
    var uri = tm.parse(id).pathname;
    var directory = cache[id]._map.fontDirectory();
    // Attempt to retrieve from cache.
    var xml = tm.templates.xrayfont({directory: uri + directory, name:name, text:text||name});
    console.log(xml);
