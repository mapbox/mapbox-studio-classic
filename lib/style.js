...
style.examples = {};
style.examples['mapbox-studio-default-style'] = 'tmpstyle://' + path.dirname(require.resolve('mapbox-studio-default-style'));
style.examples['osm-bright'] = 'tmpstyle://' + path.dirname(require.resolve('osm-bright'));
style.examples['mapbox-outdoors'] = 'tmpstyle://' + path.dirname(require.resolve('mapbox-outdoors'));
style.examples['satellite-afternoon'] = 'tmpstyle://' + path.dirname(require.resolve('satellite-afternoon'));
