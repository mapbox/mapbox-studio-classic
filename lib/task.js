...
// A Task object, representing a piped readstream which is not yet finished.
function Task(id, type, read, progress) {
    ...
    if (!(read instanceof stream.Readable)) throw new Error('Task read must be a readable stream');
