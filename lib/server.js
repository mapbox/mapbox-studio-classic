...
app.put('/style.json', middleware.writeStyle, function(req, res) {
    res.send({
        _recache: false,
...
app.get('/style.json', middleware.style, function(req, res) {
...
function tile(req, res, next) {
    ...
    var source = req.params.format === 'vector.pbf' ? req.style._backend._source : req.style;
...
app.get('/style.xml', middleware.style, function(req, res) {
...
app.get('/source.xml', middleware.source, function(req, res) {
    res.set({'content-type':'text/xml'});
...
app.put('/source.json', middleware.writeSource, function(req, res) {
    res.send({
...
app.get('/source.json', middleware.source, function(req, res) {
...
app.get('/app/cartoref.js', function(req, res) {
    res.set({
...
app.get('/new/source', middleware.exporting, middleware.newSource, function(req, res) {
    res.redirect('/source?id=' + req.source.data.id);
});

app.get('/', middleware.latest, function(req, res) {
...
app.get('/history.json', middleware.userTilesets, middleware.history, function(req, res) {
...
app.get('/geocode', middleware.userTilesets, function(req, res) {
