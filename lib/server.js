...
carto.tree.Reference.setVersion('2.3.0');
...
app.get('/update', function(req, res, next) {
    res.send(tm.templates.update({
        ...
        current: req.query.current || null,
        error: false
    }));
});
...
app.get('/style', middleware.style, middleware.history, middleware.examples, middleware.version, function(req, res, next) {
...
app.get('/source', middleware.source, middleware.history, middleware.examples, middleware.version, function(req, res, next) {
