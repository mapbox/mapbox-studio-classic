...
app.use('/oauth/config', function(req, res, next){
    ...
    if (req.query.MapboxAPITile === 'a.tiles.mapbox.com') req.query.MapboxAPITile = MapboxAPITile;
...
app.use('/oauth/atlas', function(req, res, next){
    if (tm.apiConfig('MapboxAPITile') === 'http://a.tiles.mapbox.com') return res.redirect('/oauth/mapbox');
