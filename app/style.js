...
Editor.prototype.gazetteer = function(ev) {
  ...
  var gazetteer = $.getJSON('../ext/gazetteer.json', function(data) {
    for (var i=0;i<data.length;i++) {
      ...
      $('#gazetteerlist').append('<h3>'+name+'</h3>'+'<img src="http://api.tiles.mapbox.com/v4/examples.map-zr0njcqy/'+lat+','+lon+','+zoom+'/300x300.png?access_token=pk.eyJ1IjoicGV0ZXJxbGl1IiwiYSI6ImpvZmV0UEEifQ._D4bRmVcGfJvo1wjuOpA1g">');
    }
  });
